...
<body>
    <header>
        <nav>
            <div class="container1"><!--Es la seccion que se encuentra en el encabezado-->
                <div class="fontawesome-cog" id="icon"></div>
                <ul>
                    <li>
                        <a href="../index.html">Inicio</a><!--enlazamos la direccion en donde se encuentra la pagina-->
                    </li>
                    <li>
        ...
        <div class="container1">
            <h1 class="titulo">Tienda de Vero</h1><!--Es el titulo que se encuentra en la parte del encabezado-->
        </div>
    </header>
    ...
    <div class="About">
        ...
        <div class="contenedor__about">
            <h1>Vision</h1>
            <p>Crear un mejor día dulce y colorido para todos los estudiantes del TecNM en Celaya. Buscando ser el destino de varios con experiencia única y deliciosa al satisfacer con las golosinas. </p>
        </div>
        <div class="contenedor__about">
            <h1>Valores</h1>
                    ...
                    <div class="col-12 col-md-6 col-lg-3">
                        <div class="kilimanjaro_part m-top-15">
                            ...
                            <ul class="kilimanjaro_links">
                                ...
                                <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i>Politicas de
                                        Privacidad</a></li>
                        ...
                        <div class="kilimanjaro_part">
                            ...
                            <div class="kilimanjaro_blog_area">
                                <div class="kilimanjaro_thumb">
                                    <img class="img-fluid"
                                        src=""
                                        src="https://www.wradio.com.co/resizer/cfeoyTD9YahBRwYViwi3Sh1MWAU=/650x488/filters:quality(70)/cloudfront-us-east-1.images.arcpublishing.com/prisaradioco/E7MNWHCDDNHHVACI5WRESDIXXE.jpg"
                                        alt="">
                                </div>
